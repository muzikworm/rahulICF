...
password_reset = require('../models/pwdreset');
...
exports.forgotpass = function(req, res){
  ...
  user.findOne({email: req.body.email}, function(err, result){
    if(result != null) {
      ...
      content = new helper.Content("text/html", "Click the link below to reset your password. <a href='http://localhost:35725/password_reset/"+token+"'>Reset Passowrd</a>. ");
